This dataset is an extract from the **National In‑Patient Register (Slutenvård)**, covering **1987‑01‑01** to **2022‑03‑31**. It includes all Predict cohort individuals with relevant register records.
...
**ICD notes.** In‑house translations/mappings are used to assist interpretability. Please verify annotations independently. Selected references:  
